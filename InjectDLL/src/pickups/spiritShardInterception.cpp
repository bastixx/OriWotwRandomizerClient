...
INTERCEPT(void, SeinPickupProcessor__OnCollectSpiritShardPickup, (SeinPickupProcessor_o* this_ptr, SpiritShardPickup_o* spiritShardPickup), {
...
INTERCEPT(void, SeinPickupProcessor__OnCollectedShardSlotUpgrade, (SeinPickupProcessor_o* this_ptr, ShardSlotUpgradePickup_o* shardSlotPickup), {
	collecting_spirit_shard = true;
	SeinPickupProcessor__OnCollectedShardSlotUpgrade(this_ptr, shardSlotPickup);
	collecting_spirit_shard = false;
});

INTERCEPT(Moon_uberSerializationWisp_PlayerUberStateShards_Shard_o*, PlayerSpiritShards__AddNewShardToInventory, (PlayerSpiritShards_o* this_ptr, uint8_t spiritShardType), {
...
INTERCEPT(void, PlayerSpiritShards__AddGlobalShardSlot, (PlayerSpiritShards_o* this_ptr), {
	if(collecting_spirit_shard)
		return;
