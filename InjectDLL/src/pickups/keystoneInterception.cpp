...
INTERCEPT(void, SeinPickupProcessor__OnCollectKeystonePickup, (SeinPickupProcessor_o* this_ptr, KeystonePickup_o* keystonePickup), {
...
INTERCEPT(void, SeinInventory__set_Keystones, (SeinInventory_o* this_ptr, int32_t value), {
