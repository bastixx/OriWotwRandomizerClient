...
INTERCEPT(void, SeinPickupProcessor__OnCollectOrePickup, (SeinPickupProcessor_o* this_ptr, OrePickup_o* orePickup), {	
	is_collecting_ore = true;
	SeinPickupProcessor__OnCollectOrePickup(this_ptr, orePickup);
	is_collecting_ore = false;
});

INTERCEPT(void, SeinLevel__set_Ore, (SeinLevel_o* this_ptr, int32_t value), {
